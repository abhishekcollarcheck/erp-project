...
//     const rows =
//       await attendanceCombinedService
//         .getCombinedForEmployee(
//           employeeId,
//           startDate,
//           endDate,
//           companyId,
...
//     const summary =
//       this.calculateMonthlySummary(rows);

//     // ----------------------------------------------------------
//     // Store / update monthly record
//     // ----------------------------------------------------------

//     await EmployeeMonthlyAttendance.upsert({
...
//       // Half day
//       //
//       // Keep this based on your actual FinalAttendanceStatus.
//       // --------------------------------------------------------
//       if (
//         status === "HALF_DAY" ||
//         status === "HALF-DAY"
...
//          * IMPORTANT:
//          *
//          * These names should be changed according to
//          * your actual LeaveType values.
//          */
//         const leaveType =
//           String(
//             row.leaveType ?? "",
...
//     // Working days
//     //
//     // Calendar days minus weekly offs and holidays.
//     // ----------------------------------------------------------
//     const working_days =
//       calendar_days -
//       weekly_off_days -
...
//     //
//     // Average only against days having working hours.
//     // ----------------------------------------------------------
//     const daysWithWorkingHours =
//       rows.filter(
//         row =>
//           typeof row.working_hours ===
//             "number" &&
//           row.working_hours > 0,
//       ).length;
...
//       total_working_hours:
//         Number(
//           total_working_hours.toFixed(2),
//         ),
//       average_working_hours:
//         Number(
//           average_working_hours.toFixed(2),
//         ),
//       total_punches,
//     };
//   }
...
// export const attendanceMonthlyService =
//   new AttendanceMonthlyService();
