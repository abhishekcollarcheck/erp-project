// // jobs/attendance-monthly.cron.ts
// import { Employee } from "@/database/models";
// import cron from "node-cron";
// import pLimit from "p-limit";
// import { attendanceMonthlyService } from "./attendance-monthly.service";
// // import { Employee } from "../database/models/Employee";
// // import { attendanceMonthlyService } from "../services/attendance/attendance-monthly.service";

// function getYesterdayDateString(): string {
//   // do the date math in IST explicitly, don't rely on process TZ
//   const now = new Date(
...
// async function runMonthlyAttendanceJob() {
//   const endDate = getYesterdayDateString();
//   console.log(`[attendance-cron] Starting run for ${endDate}`);

//   const employees = await Employee.findAll({
//     attributes: ["id", "company_id"],
//     where: { is_active: true }, // adjust to your actual column
//   });

//   const limit = pLimit(5); // cap concurrency so you don't hammer MSSQL/Trakola
...
//       console.error(`[attendance-cron] Employee ${employees[i]?.id} failed:`, f.reason);
//     }
//   });
// }

// export function scheduleAttendanceMonthlyCron() {
...
// async function runMonthlyAttendanceJob(): Promise<void> {
//   const endDate = getYesterdayDateString();
//   console.log(`[attendance-cron] Starting run for ${endDate}`);
