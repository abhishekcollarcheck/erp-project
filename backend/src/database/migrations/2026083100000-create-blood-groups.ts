...
export async function up(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.createTable('blood_groups', {
    id: {
  ...
  await addIndexIfMissing(queryInterface, 'blood_groups', ['display_order']);
}

export async function down(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.dropTable('blood_groups');
}