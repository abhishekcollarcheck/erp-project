...
export async function up(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.createTable('emergency_relationships', {
    id: {
  ...
  await addIndexIfMissing(queryInterface, 'emergency_relationships', ['display_order']);
}

export async function down(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.dropTable('emergency_relationships');
}