...
// its indexes on many local DBs before this migration existed, so addIndex
...
export async function up(queryInterface: QueryInterface): Promise<void> {
  ...
  // Indexes
  await addIndexIfMissing(queryInterface, 'employee_types', ['display_order']);
  await addIndexIfMissing(queryInterface, 'employee_types', ['is_active']);
}
