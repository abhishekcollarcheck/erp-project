...
export async function up(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.createTable('modes_of_payment', {
    id: {
  ...
  await addIndexIfMissing(queryInterface, 'modes_of_payment', ['display_order']);
}

export async function down(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.dropTable('modes_of_payment');
}