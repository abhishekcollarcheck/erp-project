...
export async function up(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.createTable('probation_periods', {
    id: {
  ...
  await addIndexIfMissing(queryInterface, 'probation_periods', ['display_order']);
  await addIndexIfMissing(queryInterface, 'probation_periods', ['is_active']);
}

export async function down(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.dropTable('probation_periods');
}