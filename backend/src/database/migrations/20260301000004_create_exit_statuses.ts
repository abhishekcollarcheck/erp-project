...
export async function up(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.createTable('exit_statuses', {
    id: {
  ...
  await addIndexIfMissing(queryInterface, 'exit_statuses', ['display_order']);
  await addIndexIfMissing(queryInterface, 'exit_statuses', ['is_active']);
}

export async function down(queryInterface: QueryInterface): Promise<void> {
  await queryInterface.dropTable('exit_statuses');
}