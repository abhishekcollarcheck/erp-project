...
// //     for (const department_name of ['Commercial', 'Accounts', 'Automation', 'HR', 'Graphics', 'Admin', 'Project', 'Service', 'IT', 'Estimation', 'Management', 'Purchase', 'Tender', 'Sales', 'Technical', 'Legal', 'Regulatory Affairs', 'Store', 'Ortho', 'Maintenance', 'Design', 'Quality', 'Credit Control', 'International Marketing', 'Field', 'Projects', 'Facility Management (Operations)', 'PTS and Project', 'CSSD', 'Quality Control', 'Marketing', 'Operations']) {
// //       const code = department_name.split(' ').map((w: string) => w[0]).join('').toUpperCase();
// //       const [d] = await Department.findOrCreate({
// //         where: { department_name },
// //         defaults: { department_name, department_code: code},
// //       });
// //       deptMap.set(department_name, d.id);
// //     }
...
// //     //       section: 'Address',
// //     //       fields: [
// //     //         { field_key: 'present_house_type', label: 'House Type', field_type: 'select' },
// //     //         { field_key: 'present_house_no', label: 'Present House No', field_type: 'text' },
// //     //         { field_key: 'present_area', label: 'Present Area', field_type: 'text' },
// //     //         { field_key: 'present_district', label: 'Present District', field_type: 'text' },
// //     //         { field_key: 'present_city', label: 'Present City', field_type: 'text' },
// //     //         { field_key: 'present_state', label: 'Present State', field_type: 'text' },
// //     //         { field_key: 'present_country', label: 'Present Country', field_type: 'text' },
// //     //         { field_key: 'present_pincode', label: 'Present Pincode', field_type: 'text' },
// //     //         { field_key: 'perm_address_type', label: 'Permanent Address Type', field_type: 'select' },
// //     //         { field_key: 'perm_house_type', label: 'House Type', field_type: 'select' },
// //     //         { field_key: 'perm_house_no', label: 'House No', field_type: 'text' },
// //     //         { field_key: 'perm_district', label: 'District', field_type: 'text' },
// //     //         { field_key: 'perm_city', label: 'City', field_type: 'text' },
// //     //         { field_key: 'perm_state', label: 'State', field_type: 'text' },
// //     //         { field_key: 'perm_country', label: 'Country', field_type: 'text' },
// //     //         { field_key: 'perm_pincode', label: 'Pincode', field_type: 'text' },            
// //     //       ],
// //     //     },
// //     //     {
// //     //       section: 'Family',
// //     //       fields: [
// //     //         { field_key: 'father_salutation', label: 'Father Salutation', field_type: 'select' },
...
// //     //         { field_key: 'father_status', label: 'Father Status', field_type: 'select' },
// //     //         { field_key: 'mother_salutation', label: 'Mother Salutation', field_type: 'select' },
// //     //         { field_key: 'mother_name', label: 'Mother Name', field_type: 'text' },
// //     //         { field_key: 'mother_age_dob', label: 'Mother Age/DOB', field_type: 'text' },
// //     //         { field_key: 'mother_occupation', label: 'Mother Occupation', field_type: 'select' },
// //     //       ],
// //     //     },
// //     //     {
...
// //     //       fields: [
// //     //         { field_key: 'personal_bank_name', label: 'Bank Name', field_type: 'text' },
// //     //         { field_key: 'personal_bank_account', label: 'Account Number', field_type: 'text' },
// //     //         { field_key: 'personal_ifsc', label: 'IFSC Code', field_type: 'text' },
// //     //         { field_key: 'personal_bank_branch', label: 'Branch Name', field_type: 'text' },
// //     //         { field_key: 'official_bank_name', label: 'Official Bank Name', field_type: 'text' },
// //     //         { field_key: 'official_bank_account', label: 'Official Account Number', field_type: 'text' },
// //     //         { field_key: 'official_ifsc', label: 'Official IFSC Code', field_type: 'text' },
// //     //         { field_key: 'official_bank_branch', label: 'Official Branch Name', field_type: 'text' },            
// //     //       ],
// //     //     },
// //     //     {
// //     //       section: 'Experience',
...
>>>>>>> origin/deploy1
    ...
    // =====================================================
    //
    // Keep this section commented if your Role / permission
    // migrations are not ready yet.
    //
    // =====================================================
    ...
    //   allTemplates.map((template) => [template.slug, template])
    // );
    //
    // for (const def of TEMPLATE_DEFS) {
    //   const template = templateMap.get(def.slug);
    //
    //   if (!template) {
    //     continue;
    //   }
