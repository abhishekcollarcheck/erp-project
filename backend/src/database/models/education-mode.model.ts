...
EducationMode.init(
  ...
  {
    sequelize,
    tableName: 'education_modes',
    modelName: 'EducationMode',
    indexes: [
      { unique: true, fields: ['name'], name: 'education_modes_name_unique' },
      { unique: true, fields: ['code'], name: 'education_modes_code_unique' },
    ],
  }
);