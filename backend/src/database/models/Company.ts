...
type CompanySettingCreationAttributes = Optional<
...
export class CompanySetting
  extends Model<
    CompanySettingAttributes,
    CompanySettingCreationAttributes
  >
  implements CompanySettingAttributes
{
  public id!: number;
...
CompanySetting.init(
  ...
  },
  {
    ...
    indexes: [
      {
        unique: true,
        name: 'company_settings_company_key_unique',
        fields: ['company_id', 'key'],
      },
      {
        name: 'company_settings_company_id_index',
        fields: ['company_id'],
      },
    ],
  }
...
export const COMPANY_SETTING_KEYS = {
  LEAVE_APPROVAL_FLOW: 'leave_approval_flow',
  PROBATION_DAYS: 'probation_days',
  PAYSLIP_FOOTER: 'payslip_footer',
  WORK_WEEK: 'work_week',
  ATTENDANCE_CUTOFF: 'attendance_cutoff',
  PORTAL_WELCOME_MSG: 'portal_welcome_msg',
} as const;
...
type CompanyModuleCreationAttributes = Optional<
  CompanyModuleAttributes,
  'id' | 'is_core' | 'is_active' | 'display_order' | 'created_at' | 'updated_at'
>;

export class CompanyModule
  extends Model<
    CompanyModuleAttributes,
    CompanyModuleCreationAttributes
  >
  implements CompanyModuleAttributes
{
  public id!: number;
...
CompanyModule.init(
  ...
  },
  {
    ...
    indexes: [
      {
        unique: true,
        name: 'company_modules_company_module_unique',
        fields: ['company_id', 'module'],
      },
      {
        name: 'company_modules_company_active_index',
        fields: ['company_id', 'is_active'],
      },
    ],
  }
