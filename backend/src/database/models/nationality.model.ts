...
interface NationalityCreationAttributes
  extends Optional<NationalityAttributes, 'id' | 'display_order' | 'is_active'> {}

export class Nationality
  extends Model<NationalityAttributes, NationalityCreationAttributes>
