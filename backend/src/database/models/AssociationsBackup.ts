...
// import { Employee } from './Employee';
// import { Company } from './Company';
// import { Department, CompanyDepartment } from './Department'; // <-- ADD CompanyDepartment HERE
// // import { Department } from './Department';
// import { Designation } from './Designation';
...
// Employee.hasOne(EmployeeCommitmentProbation, {
//   foreignKey: 'employee_id',
//   as: 'commitmentProbation',
// });

// Employee.hasOne(EmployeeSchemes, {
//   foreignKey: 'employee_id',
//   as: 'schemes',
// });

// Employee.hasOne(EmployeePersonal, {
//   foreignKey: 'employee_id',
//   as: 'personal',
// });

// Employee.hasOne(EmployeeFamily, {
//   foreignKey: 'employee_id',
//   as: 'family',
// });

// Employee.hasMany(EmployeeAddress, {
//   foreignKey: 'employee_id',
//   as: 'addresses',
// });
...
// Employee.hasOne(EmployeeStatutory, {
//   foreignKey: 'employee_id',
//   as: 'statutory',
// });

// Employee.hasMany(EmployeeBankDetail, {
//   foreignKey: 'employee_id',
//   as: 'bankDetails',
// });
...
// Employee.hasOne(EmployeeAssetDeduction, {
//   foreignKey: 'employee_id',
//   as: 'assetDeduction',
// });

// Employee.hasOne(EmployeeExperience, {
//   foreignKey: 'employee_id',
//   as: 'experience',
// });

// Employee.hasOne(EmployeeEducation, {
//   foreignKey: 'employee_id',
//   as: 'education',
// });

// Employee.hasOne(EmployeeOnboardingDocs, {
//   foreignKey: 'employee_id',
//   as: 'onboardingDocs',
// });

// Employee.hasMany(EmployeeTransfer, {
//   foreignKey: 'employee_id',
//   as: 'transfers',
// });
...
// // ─── Employee Self-Referential Managers ──────────────────────────────────────

// Employee.belongsTo(Employee, {
//   foreignKey: 'l1_manager_id',
//   as: 'l1Manager',
// });

// Employee.belongsTo(Employee, {
//   foreignKey: 'l2_manager_id',
//   as: 'l2Manager',
// });
...
// Employee.hasMany(OtpRequest, {
//   foreignKey: 'employee_id',
//   as: 'otpRequests',
// });

// OtpRequest.belongsTo(Employee, {
//   foreignKey: 'employee_id',
//   as: 'employee',
// });
...
// // ─── Employee ↔ Role ─────────────────────────────────────────────────────────
// // Many-to-many via employee_roles
...
// Role.belongsTo(RoleTemplate, {
//   foreignKey: 'template_id',
//   as: 'template',
// });

// RoleTemplate.hasMany(Role, {
//   foreignKey: 'template_id',
//   as: 'roles',
// });
...
// HrModule.hasMany(FormDefinition, {
//   foreignKey: 'module_id',
//   as: 'forms',
// });

// FormDefinition.belongsTo(HrModule, {
//   foreignKey: 'module_id',
//   as: 'module',
// });

// FormDefinition.hasMany(DynamicField, {
//   foreignKey: 'form_id',
//   as: 'fields',
// });

// DynamicField.belongsTo(FormDefinition, {
//   foreignKey: 'form_id',
//   as: 'form',
// });

// DynamicField.hasMany(FieldOption, {
//   foreignKey: 'field_id',
//   as: 'options',
// });

// FieldOption.belongsTo(DynamicField, {
//   foreignKey: 'field_id',
//   as: 'field',
// });

// DynamicField.hasMany(FieldPermissionV2, {
//   foreignKey: 'field_id',
//   as: 'fieldPerms',
// });

// FieldPermissionV2.belongsTo(DynamicField, {
//   foreignKey: 'field_id',
//   as: 'field',
// });
...
// GroupPermission.belongsTo(PermissionGroup, {
//   foreignKey: 'group_id',
//   as: 'group',
// });
...
// PermissionGroup.hasMany(GroupPermission, {
//   foreignKey: 'group_id',
//   as: 'groupPermissions',
// });
...
// UserGroup.belongsTo(PermissionGroup, {
//   foreignKey: 'group_id',
//   as: 'group',
// });

// UserGroup.belongsTo(Employee, {
//   foreignKey: 'employee_id',
//   as: 'employee',
// });

// PermissionGroup.hasMany(UserGroup, {
//   foreignKey: 'group_id',
//   as: 'userGroups',
// });

// Employee.hasMany(UserGroup, {
//   foreignKey: 'employee_id',
//   as: 'userGroups',
// });
