...
export function BulkUploadModal({
  ...
  const downloadErrorReport = () => {
    ...
    const csvRows = [
      'Row,Employee Name,Error Reason',
      ...result.errors.map(
        error =>
  ...
  return (
    <Modal
      ...
      subtitle="Import multiple employees using CSV or Excel files"
      width={600}
      footer={
        result ? (
          <div
          ...
          >
            ...
            {file ? (
              <>
                ...
                >
                  {formattedFileSize} · Click to replace
                </div>
              </>
            ) : (
              <>
