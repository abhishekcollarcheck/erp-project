      ...
      <MasterDataLayout>
        <div className="flex h-full w-full flex-col bg-white p-6 font-sans text-gray-800">
          ...
          <div className="flex items-center justify-between border-b border-gray-100 pb-4">
            <div>
              <h1 className="text-xl font-bold tracking-tight text-gray-900">T-Shirt/Shirt Size</h1>
          ...
          <div className="my-6 rounded-xl border border-gray-200 bg-white p-4 shadow-xs">
            ...
            <div className="flex gap-2">
              <input
                ...
                onKeyDown={(e) => e.key === 'Enter' && handleAddShirtSize()}
                placeholder="Add t-shirt/shirt size..."
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <span className="flex h-6 w-6 items-center justify-center rounded-full bg-gray-100 text-xs font-bold text-gray-400">
                {filteredShirtSizes.length}
              </span>
            </div>

            {/* T-Shirt/Shirt Size Chips Container */}
            <div className="mt-6 flex flex-wrap items-center gap-2.5">
              {filteredShirtSizes.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => deleteShirtSize.mutate(item.id)}
