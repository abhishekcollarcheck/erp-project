    ...
    <AppShell>
      <MasterDataLayout>
        <div className="flex h-full w-full flex-col bg-white p-6 font-sans text-gray-800">
          {/* Top Level Nav Action Row */}
          <div className="flex justify-end gap-2 mb-2">
            <button className="h-8 rounded-md border border-gray-200 px-3 text-xs font-semibold text-gray-700 hover:bg-gray-50">
              Employees
            </button>
            <button className="flex h-8 items-center gap-1 rounded-md bg-blue-600 px-3 text-xs font-semibold text-white hover:bg-blue-700">
              <Plus size={14} /> Add
            </button>
          </div>
          ...
          <div className="my-6 rounded-xl border border-gray-200 bg-white p-4 shadow-xs">
            ...
            {/* Emergency Relationship Chips Container */}
              ...
              {filteredRelationships.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => deleteRelationship.mutate(item.id)}
