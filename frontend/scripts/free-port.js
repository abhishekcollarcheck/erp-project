/**
 * Frees the frontend's port before dev/start so a leftover process from a
 * previous run (crashed terminal, orphaned background process, a second
 * launch you forgot was running) never causes EADDRINUSE again. Runs
 * automatically via npm's "pre" hook (predev/prestart) — no manual
 * intervention needed.
 */
